...
public class MainPage extends AbstractPage {
    ...
    By apartmentSelection = By.xpath("//*[@class='mt-5 i-block mr-15'][1]");
    ...
    public List<String> getTileQuantityRooms() {
        ...
        for (WebElement tile : getTilesRooms()) {
            //forRoomsReturn.add(tile.findElements(By.className("wrap_desc")).get(1).findElement(By.cssSelector(".mt-5.i-block.mr-15")).toString());
            forRoomsReturn.add(String.valueOf(tile.findElement(apartmentSelection)));
        }
    ...
    public MainPage setGeolocation() throws InterruptedException {
        ...
        //scrollDownToElement(driver.findElement(regionComfirmation));
